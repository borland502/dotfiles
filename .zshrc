...
alias tnginxaccesslog='tail -100f /usr/local/Cellar/nginx/1.15.5/logs/access.log'
alias tnginxerrorlog='tail -100f /usr/local/Cellar/nginx/1.15.5/logs/error.log'
...
alias vlabdb=sql "jhettenhouser@$VLAB_DB_HOST:1521:dte3"
